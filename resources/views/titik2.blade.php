...
<body >
    @foreach($titiks as $titik)
        ...
        <button id="butTitiks" onclick="isi({{$titik['xDot']}},{{$titik['yDot']}},'{{$titik['Nama']}}')" style="position: absolute; top:{{$titik['yDot']}}px; left:{{$titik['xDot']}}px;z-index:100;">{{$titik['Nama']}}</button>
    @endforeach
